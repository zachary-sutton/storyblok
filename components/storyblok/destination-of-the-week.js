const DOTW = ({blok}) => {
    ...
    return (
        <>
        <div className="w-11/12 flex justify-start m-auto xl:w-8/12">
            <h1 className="font-my-font text-3xl">Destination of the week</h1>
        </div>
        <div className="w-11/12 m-auto flex justify-between bg-right bg-cover rounded-3xl shadow-2xl xl:w-8/12 cursor-pointer" style={{backgroundImage: `url(${blok.bg_img.filename})`}}>
